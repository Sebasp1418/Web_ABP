        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-book"></i> <span>Sistema ABP</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-cog"></i> Administracion <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="index3.html">Programas Academicos</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-users"></i> Docentes <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Docentes</a></li>
                      <li><a href="form_advanced.html">Grupos</a></li>
                      <li><a href="form_validation.html">Horario de asesoria</a></li>
                    
                    </ul>
                  </li>
                  <li><a><i class="fa fa-graduation-cap"></i> Estudiantes <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="general_elements.html">Grupos de Estudiantes</a></li>
                    </ul>
                  </li>
